...
"""
This is a custom launcher written to test the launch API
"""
...
import torch
import torchelastic.rendezvous.custom_rendezvous  # noqa: F401
...
def parse_args(args):
    ...
    parser = ArgumentParser(description="torchelastic elastic training singularity launcher")
...
def main(args=None):
    ...
    wg = elastic_agent.get_worker_group()
    
    log.info(">>> Group Rank {} Group Size {}".format(wg.group_rank, wg.group_world_size))
